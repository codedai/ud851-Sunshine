...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int WEATHER_ID = 719;
    ...
    private void loadWeatherData() {
        ...
        queryBundle.putString(LOCATION_MESSAGE, location);

        LoaderManager loaderManager = getSupportLoaderManager();
        Loader<String[]> weatherSearchLoader = loaderManager.getLoader(WEATHER_ID);

        if (weatherSearchLoader == null) {
            loaderManager.initLoader(WEATHER_ID, queryBundle, this);
        } else {
            loaderManager.restartLoader(WEATHER_ID, queryBundle, this);
        }
    ...
    public Loader<String[]> onCreateLoader(int i, final Bundle bundle) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            protected void onStartLoading() {
                ...
                if (mWeatherData != null) deliverResult(mWeatherData);
            ...
            public String[] loadInBackground() {
                String location = bundle.getString(LOCATION_MESSAGE);
